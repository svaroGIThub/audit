      ...
      >
        ...
        <Form className="bg-white rounded shadow-sm p-3 mt-4">
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              type="checkbox"
              label="Informes sobre pasivos contingentes."
              name="c4"
              defaultChecked={this.state.c4}
              onChange={this.handleChangeChk}
            />
          </Form.Group>
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              ...
              name="c6"
              defaultChecked={this.state.c6}
              onChange={this.handleChangeChk}
            />
          </Form.Group>

          <Form.Text
            className="mb-3 mt-0 ml-lg-4"
            style={styles.formssubtitles}
          >
          ...
          <Form.Group className="ml-lg-4 pl-lg-4">
            <Form.Check
              type="checkbox"
              label="Corto y largo plazo."
              name="c7"
              defaultChecked={this.state.c7}
              onChange={this.handleChangeChk}
            />
          </Form.Group>
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              type="checkbox"
              label="Endeudamiento neto, financiamiento menos amortización."
              name="c9"
              defaultChecked={this.state.c9}
              onChange={this.handleChangeChk}
            />
          </Form.Group>
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              ...
              name="c10"
              defaultChecked={this.state.c10}
              onChange={this.handleChangeChk}
            />
          </Form.Group>

          <Form.Text className="lead mb-4 mt-4">
            II. Información contable, con la desagregación siguiente:
          </Form.Text>

          <Form.Group className="ml-lg-4">
            <Form.Check
              type="checkbox"
              label="Estado analítico de ingresos, del que se derivará la presentación en clasificación económica or fuente de financiamiento y concepto."
              name="c11"
              defaultChecked={this.state.c11}
              onChange={this.handleChangeChk}
            />
          </Form.Group>

          <Form.Text
            className="mb-2 mt-0 ml-lg-4"
            style={styles.formssubtitles}
          >
          ...
          <Form.Group className="ml-lg-4 pl-lg-4">
            <Form.Check
              type="checkbox"
              label="Económica y por objeto del gasto."
              name="c13"
              defaultChecked={this.state.c13}
              onChange={this.handleChangeChk}
            />
          </Form.Group>
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              type="checkbox"
              label="Endeudamiento neto, financiamiento menos amortización, del que derivará la clasificación por su origen en interno y externo."
              name="c15"
              defaultChecked={this.state.c15}
              onChange={this.handleChangeChk}
            />
          </Form.Group>
          ...
          <Form.Group className="ml-lg-4">
            <Form.Check
              type="checkbox"
              label="Un flujo de fondos que resuma todas las operaciones y los indicadores de la postura fiscal."
              name="c17"
              defaultChecked={this.state.c17}
              onChange={this.handleChangeChk}
            />
          </Form.Group>

          <Form.Text className="lead mb-4 mt-4">
            III. Información contable, con la desagregación siguiente:
          </Form.Text>
