      ...
      >
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            <tr>
              <td>1</td>
              <td>
                Ubicar en áreas específicas de auditoría aquellas cuentas de mayor de balance y de resultados que se relacionen entre sí debido a su naturaleza contable, que sus movimientos contables se complementan y/o sus aplicaciones contables producen movimientos contables simultáneos en varias cuentas.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>3</td>
              <td>
                Seleccionar las pruebas analíticas y de verificación a efectuar, considerando la materialidad preliminar de auditoría.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Preparar programa de trabajo específico para cada área de auditoría y para el área general.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>3</td>
              <td>Solicitar el Programa Operativo Anual para el ejercicio {this.state.selectedAudit.year}, así como, los informes trimestrales de avance en el cumplimiento de metas y evaluar el cumplimiento de los objetivos y metas establecidos en dicho programa.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>6</td>
              <td>
                Preparar o actualizar el cuestionario sobre eventos posteriores al cierre del ejercicio y hasta la fecha en que se emitirá el dictamen en el {this.state.selectedAudit.year}.
		</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
...
A que los activos, pasivos y patrimonio existen, que son del periodo auditado, están completos, son propiedad de la entidad, fueron contabilizados de acuerdo a postulados de contabilidad gubernamental y bases especiales de registro.</td>
        ...
        <p>A/ Corroborar la existencia y funcionamiento de controles para el ejercicio del presupuesto.</p>
        <p>B/ Verificar el cumplimiento en las disposiciones normativas y legales en vigor en el ejercicio del presupuesto.</p>
...
<ul>
                  <li>Oficio de autorización del presupuesto a ejercer para {this.state.selectedAudit.year}, anexo el detalle del mismo por partida y unidad presupuestal.</li>
            ...
            <tr>
              <td>2</td>
              <td>
                Cotejar que el presupuesto original autorizado (publicado) para el ejercicio {this.state.selectedAudit.year}, corresponda al manifestado en su informe de avance presupuestal. Verificar que éste último cuente con firmas de autorización de los titulares de la Entidad. </td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Solicitar al Órgano de Control Interno de la Entidad sus informes sobre la verificación periódica de los resultados de ejecución de los programas y presupuestos.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>5</td>
              <td>
                Preparar confirmaciones a la Instancias correspondientes, solicitando por el ejercicio {this.state.selectedAudit.year} lo siguiente:
<ul>
                  <li>Presupuesto de egresos original y sus modificaciones para el ejercicio {this.state.selectedAudit.year}.</li>
                  <li>Relación de radicaciones efectuadas.</li>
                  <li>Importe de los saldos por cobrar o por pagar a la Entidad al 31 de diciembre de {this.state.selectedAudit.year}.</li>
                </ul>
              </td>
              <td>Link</td>
              <td> <DatePicker
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Obtener relación de los fondos revolventes que operaron en el periodo de revisión, anexando copia del documento que ampare su custodia.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>2</td>
              <td>
                Solicitar las políticas y normas que regulan el otorgamiento, custodia, manejo y destino de fondos revolventes y en la revisión documental de gastos pagados con fondos revolventes. Verificar el cumplimiento a la normatividad en vigor.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Verificar la existencia de inversiones en valores o cuentas bancarias productivas y que los intereses ganados en todas las cuentas bancarias hayan sido registrados contablemente.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>5</td>
              <td>
                Obtener relación de cuentas bancarias manejadas durante {this.state.selectedAudit.year} señalando fecha de apertura, firmas de autorización y custodia de las mismas.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>6</td>
              <td>
                Preparar y enviar solicitudes de confirmación de saldos a las instituciones correspondientes de todas las cuentas bancarias solicitando saldos al 31 de diciembre de {this.state.selectedAudit.year}.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>7</td>
              <td>
                Obtener copia de las conciliaciones bancarias al 31 de diciembre de {this.state.selectedAudit.year} y verificar lo siguiente:
<ul>
                  ...
                  <li>En base al resumen anterior, analizar las cuentas bancarias con partidas en tránsito destacadas, identificar su correspondencia en el mes de enero y febrero de {this.state.selectedAudit.year} y de  aquellas no localizadas identificar la operación a que corresponde para su revisión documental; de las partidas pendientes de corresponder por el banco diferentes a los cheques en tránsito, solicitar copia de la documentación de aclaración turnada al banco y las respuestas recibidas.</li>
                </ul>
              </td>
              <td>Link</td>
              <td> <DatePicker
            ...
            <tr>
              <td>8</td>
              <td>
                Elaborar un resumen de las partidas en tránsito con una antigüedad superior a tres meses al 31 de diciembre de {this.state.selectedAudit.year} y comentar con la Entidad.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <h3 className="my-4">Cuentas y Documentos por Cobrar, Anticipos a Proveedores, Fondos de Reserva, Acreedores Diversos e Impuestos y Cuotas por Pagar.</h3>
        <p>Objetivo: Verificar que los saldos que se presentan correspondan a derechos y obligaciones reales y exigibles a favor y a cargo de la entidad.</p>
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Obtener la integración de los saldos que se presentan al 31 de diciembre de {this.state.selectedAudit.year} por deudor y acreedor.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>2</td>
              <td>
                Determinar los saldos que son reiterativos al ejercicio anterior y solicitar al área financiera y jurídica sus comentarios sobre su recuperabilidad o exigibilidad según corresponda.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
...
<ul>
            ...
            <tr>
              <td>4</td>
              <td>
                Solicitar información sobre la fecha y forma de recuperación y/o pago durante {this.state.selectedAudit.year}, a la fecha de la revisión.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>5</td>
              <td>
                Obtener integración de los impuestos, cuotas y otras retenciones por pagar y verificar el soporte documental del pago posterior en el ejercicio {this.state.selectedAudit.year}.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Revisar lo referente a los procesos de adjudicación y licitación, simplificada y pública, en materia de adquisiciones de bienes y de servicios, verificando lo establecido en la Ley de Adquisiciones y la normatividad aplicable a la Entidad.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Cotejar el inventario físico de las existencias en los almacenes contra los registros contables, las existencias de artículos seleccionar 30 artículos que destaquen por su importe e identificar su pedido en la relación según punto 3 y en su caso con la licitación correspondiente.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>5</td>
              <td>
                Verificar el ajuste del registro en cuenta de balance del inventario físico al 31 de diciembre de {this.state.selectedAudit.year}.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>7</td>
              <td>
                Solicitar integración de saldos de las existencias de bienes muebles al 31 de diciembre de {this.state.selectedAudit.year} y verificar que el inventario de cada tipo de bien se encuentre totalmente valuado que contenga descripción, que coincida con registros contables, seleccionar 30 activos para verificar su documentación soporte (facturas), ubicación física a la fecha de la revisión y su resguardo correspondiente.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>9</td>
              <td>
                Solicitar al área Jurídica un listado de bienes inmuebles de la Entidad indicando su situación legal vigente, analizar dicha información y cruzar con las cifras presentadas en su caso en registros contables.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>10</td>
              <td>
                Verificar el registro del(los) bien(es) inmueble(es) adquirido en el ejercicio {this.state.selectedAudit.year}, su documentación soporte, y valor asignado.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <h3 className="my-4">Impuestos, Cuotas por Pagar y otras retenciones</h3>
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Verificar que los estados financieros incluyen las provisiones de pasivos por concepto de compromisos fiscales estatales y federales. Verificar que los pasivos coincidan con los montos enterados en la declaración del mes de enero de {this.state.selectedAudit.year}.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Verificar la integración del saldo de patrimonio al 31 de diciembre de {this.state.selectedAudit.year} y su correspondencia con las cuentas de activo (bienes muebles e inmuebles).</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <p>Objetivo: Comprobar su ingreso en cuentas bancarias de la entidad y que se encuentren reflejados contablemente.</p>
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Solicitar un resumen de las radicaciones que las Instancias correspondientes efectuaron a la Entidad y validar el 100% con los oficios de autorización las radicaciones.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>2</td>
              <td>
                Solicitar y revisar al 100% la conciliación de los recursos recibidos en su caso de los fondos federales por el ejercicio {this.state.selectedAudit.year} contra los recursos ejercidos por el de la Entidad.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>3</td>
              <td>
                Preparar y enviar solicitud de información a las Instancias correspondientes sobre el presupuesto autorizado y los recursos radicados.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Solicitar a la Instancia correspondiente mediante confirmación, el detalle de las ministraciones federales y estatales radicadas por el ejercicio {this.state.selectedAudit.year}, y solicitar conciliación con los registros contables.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>5</td>
              <td>
                Verificar otros ingresos que recibió la Entidad por el periodo de revisión y el cumplimiento de los diversos ordenamientos legales aplicables.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <p>Objetivo: Verificar la correcta autorización, uso, aplicación y registro de los recursos presupuestales en gasto corriente.</p>
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Cotejar al 31 de diciembre de {this.state.selectedAudit.year} el importe consignado como presupuesto ejercido en los informes presupuestales (presupuestos) con las aplicaciones al egreso presentadas en la balanza de comprobación.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>2</td>
              <td>
                Solicitar o elaborar un resumen mensual de enero a diciembre de {this.state.selectedAudit.year} de los movimientos reportados por partida del gasto, analizar y documentar variaciones destacadas.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Solicitar las órdenes de pago seleccionadas y la documentación comprobatoria que ampare tales desembolsos para verificar en forma general que:
<ul>
                  <li>Los gastos autorizados cuenten con disponibilidad presupuestal.</li>
                  <li>Los gastos estén clasificados, de acuerdo a la clave programática correspondiente.</li>
                  <li>Los comprobantes estén a nombre de la Entidad.</li>
                  <li>Los comprobantes cuenten con requisitos fiscales (art. 29-A del CFF) como son:</li>
                  <ul>
            ...
            <tr>
              <td>5</td>
              <td>
                Efectuar entrevista para documentar los procedimientos aplicados en las adquisiciones de materiales y suministros. Evaluando el control interno existente.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>7</td>
              <td>
                En la adquisición de bienes y servicios en caso de excepciones de ley (directas) deberán cumplir con la Ley de Adquisiciones.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>8</td>
              <td>
                Observar cualquier pago por concepto de comidas, arreglos florales, donativos, obsequios y en general cualquier gasto de representación, así como, la adquisición de bienes con objeto de obsequiarlos.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>9</td>
              <td>
                Verificar la contratación de servicios de arrendamiento, de informática, de mantenimiento y conservación de vehículos, compulsando algunos de estos proveedores.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>11</td>
              <td>
                Revisar documentalmente las adquisiciones destacadas de bienes muebles y verificar selectivamente que se encuentren dentro del inventario o padrón vehicular, según sea el caso.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>12</td>
              <td>
                Verificar el cumplimiento de la normatividad relacionada para la adquisición de mobiliario y equipo, equipo de transporte, bienes informáticos, equipo médico y de laboratorio, terrenos, etc.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>13</td>
              <td>
                Compulsar de acuerdo a las muestras con algunos proveedores participantes en operaciones relevantes.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>14</td>
              <td>
                Verificar el registro correspondiente en cuentas de activo y patrimonio.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
        ...
        <p>Objetivos:</p>
        <p>A/ Comprobar que las erogaciones por remuneraciones al personal corresponden a servicios efectivamente recibidos y se encuentran debidamente clasificados y registrados.</p>
        <p>B/ Comprobar que todas las obligaciones contractuales relativas a remuneraciones y sus deducciones, se hayan registrado y valuado adecuadamente en el período correspondiente.</p>
        <p>C/ Verificar el cumplimiento con las obligaciones de retención y entero de contribuciones relacionadas con el pago de sueldos y salarios.</p>
        ...
        <Table striped bordered responsive className="mt-3 shadow-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>1</td>
              <td>
                Hacer comparativo de lo ejercido por partida al 31 de diciembre de {this.state.selectedAudit.year} contra 20XX y comentar variaciones destacadas.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>2</td>
              <td>
                Elaborar resumen mensual acumulado al 31 de diciembre de {this.state.selectedAudit.year} de las partidas que integran el renglón de servicios personales según registros contables, comparar los importes entre meses y comentar variaciones importantes.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>3</td>
              <td>
                Obtener copia de las modificaciones a sueldos y prestaciones que hayan tenido lugar en el período de revisión y realizar una prueba global, aplicando los porcentajes de incremento a las percepciones de {this.state.selectedAudit.year} para juzgar la razonabilidad del gasto que se presenta por este concepto.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>4</td>
              <td>
                Solicitar por el ejercicio de {this.state.selectedAudit.year} la siguiente información:
<ul>
                  <li>Resúmenes de nómina.</li>
                  <li>Listado de movimientos por concepto del mes seleccionado para revisión.</li>
                  <li>Tabuladores de sueldos vigentes al 31 de diciembre de {this.state.selectedAudit.year}.</li>
            ...
            <tr>
              <td>5</td>
              <td>
                Generar resúmenes de nómina, según corresponda; por partida las percepciones y por concepto las deducciones; cotejar el total obtenido con lo aplicado presupuestalmente y contablemente en el capítulo 1000.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>6</td>
              <td>
                Solicitar las nóminas del mes de noviembre y diciembre y determinar una muestra representativa de 30 empleados por cada tipo de nómina para la aplicación de los siguientes procedimientos:
<ul>
            ...
            <tr>
              <td>7</td>
              <td>
                Solicitar un comparativo mensual por tipo de personal y unidad presupuestal de las plazas autorizadas con las ocupadas, comente variaciones importantes (documentar autorización).</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>8</td>
              <td>
                Solicitar la relación de bajas del mes de diciembre y verifique la oportunidad de la aplicación según los documentos fuente y en su caso la cancelación de los cheques.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>9</td>
              <td>
                Analizar los importes que se presentan como aplicaciones al presupuesto en las partidas de compensaciones y honorarios en forma mensual, comentando en su caso variaciones importantes entre meses y/o con relación al ejercicio anterior.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>10</td>
              <td>
                Seleccionar un mes para revisar el pago de compensaciones y honorarios, teniendo especial cuidado en los siguientes aspectos:
<ul>
            ...
            <tr>
              <td>12</td>
              <td>
                Solicitar los papeles de trabajo del cálculo de la declaración anual de sueldos y salarios.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>14</td>
              <td>
                Verificar la correcta presentación en cuanto a fecha e importe de los pagos provisionales que paga la Entidad.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
            ...
            <tr>
              <td>15</td>
              <td>
                Verificar la correcta presentación de las declaraciones informativas que está obligada a presentar la Entidad por el ejercicio {this.state.selectedAudit.year}.</td>
              <td>Link</td>
              <td> <DatePicker
                selected={this.state.date}
                onSelect={this.handleSelect}
