    ...
    render() {
        ...
        return (
            <Layout
                ...
                phasesProps={[
                    { text: "Planeación", link: "/audits/planning/" },
                    { text: "Programación", link: "/audits/fieldwork/" },
                    { text: "Ejecución", link: "/audits/exection/" }
                ]}
            >
                <MyBreadcrum
                    pages={[
                        { key: "1", page: "Auditorías", link: "/audits" },
                        { key: "2", page: this.state.selectedAudit.clientAcronym + " " + this.state.selectedAudit.year, link: "nolink" }
                    ]}
                />
                ...
                <Accordion>
                    ...
                    <Card style={styles.accordionCard}>
                        ...
                        <Accordion.Collapse eventKey="1">
                            <Card.Body>
                                <p className="mb-0"><a href="/audits">Cuestionario de Control Interno.</a></p>
                            </Card.Body>
                        </Accordion.Collapse>
                    </Card>
                    <Card style={styles.accordionCard}>
                        ...
                        <Accordion.Collapse eventKey="2">
                            <Card.Body>
                                <p className="mb-0"><a href="/audits">Cédula de Estados Financieros del Sistema.</a></p>
                            </Card.Body>
                        </Accordion.Collapse>
                    </Card>
                </Accordion>
